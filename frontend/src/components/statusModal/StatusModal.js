...
import { CameraAltOutlined, Image } from "@material-ui/icons";
import { imageShow, videoShow } from "../../utils/mediaShow";
import "./statusModal.scss";

const StatusModal = () => {
  const [{ auth, theme, status, socket }, dispatch] = useContext(StateContext);
        ...
        <div className="body">
          ...
          <div className="imageShow">
            {images.map((img, index) => (
              <div key={index} id="file_img" className="imgFile">
                {img.camera ? (
