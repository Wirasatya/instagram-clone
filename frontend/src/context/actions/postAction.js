...
export const likePost = async ({ post, auth, socket }, dispatch) => {
...
export const unLikePost = async ({ post, auth, socket }, dispatch) => {
  const newPost = {
    ...post,
...
export const getPost = async ({ detailPost, id, auth }, dispatch) => {
...
export const savePost = async ({ post, auth }, dispatch) => {
...
export const unSavePost = async ({ post, auth }, dispatch) => {
  const newUser = {
    ...auth.user,
